...
CASES = [
    ...
    ("lepida.it",                    "comune.bologna.it",         True,
     "Lepida (ER) for Bologna comune (ER capoluogo)"),
    ("lepida.it",                    "comune.bolognola.mc.it",    False,
     "Lepida (ER) for Bolognola (MC=Marche) — out-of-region"),
    ("ariaspa.it",                   "comune.milano.it",          True,
     "ARIA (Lombardia) for Milano (capoluogo)"),
    ("ruparpiemonte.it",             "comune.albianodivrea.to.it", True,
     "RUPAR Piemonte for TO comune"),
    ("schule.suedtirol.it",          "comune.bolzano.bz.it",      True,
     "Sudtirol school net for BZ comune"),
    ("regione.emilia-romagna.it",    "comune.bologna.it",         True,
     "regione ER for Bologna comune"),
