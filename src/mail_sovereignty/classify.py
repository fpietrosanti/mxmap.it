...
def classify(
    ...
    local_providers = {
        ...
        # provider europei: l'MX può comunque relayare a un backend cloud (DKIM)
        "ovh",
        "hetzner",
        "ionos",
        "scaleway",
    ...
    for provider, keywords, label in [
        ...
        ("ovh", OVH_KEYWORDS, "OVH"),
        ("hetzner", HETZNER_KEYWORDS, "Hetzner"),
        ("ionos", IONOS_KEYWORDS, "IONOS"),
        ("scaleway", SCALEWAY_KEYWORDS, "Scaleway"),
        ("gandi", GANDI_KEYWORDS, "Gandi"),
        ("infomaniak", INFOMANIAK_KEYWORDS, "Infomaniak"),
